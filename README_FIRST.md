...
# PromptLens v0.2.1 실행 방법

이 버전은 OG 이미지와 소셜 미리보기 메타 태그를 추가했습니다.

# PromptLens v0.2.0 실행 방법

이 버전은 프롬프트 품질 강화를 위한 길이/정리 목적 선택을 포함합니다.

# PromptLens v0.1.8 실행 방법

이 버전은 상단 버전 표시가 모든 화면 크기에서 보이도록 수정했습니다.
